...
public class DateAdapter {
    ...
    public String monthOfYear(Context context, int month){
        String monthOfYear = "";
    ...
    public String dayOfWeekString(Context context, int dayOfWeek){
    ...
    public String dateStringText(Context context){
        ...
        return dayOfWeekString(context, dayOfWeek) + ","
                + day + " "
                + monthOfYear(context, month) + " "
                + year;
    }
